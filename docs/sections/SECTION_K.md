...
- [x] **K1: Multiple GPX tracks** (4-5 hours)
  ...
  - Tests: `tests/integration/MapMultiTrack.test.tsx`
...
- [x] **K2: Elevation profile** (6-8 hours)
  ...
  - Tests: `tests/unit/components/preview/ElevationProfile.test.tsx`, `tests/integration/MapPreview.test.tsx`
...
- [x] **K3: Data overlays on video** (5-6 hours)
  ...
  - Tests: `tests/unit/components/preview/DataOverlay.test.tsx`, `tests/integration/DataOverlay.test.tsx`
...
- [x] **K4: Custom map styles** (3-4 hours)
  ...
  - Tests: `tests/integration/MapPreview.test.tsx`
...
- [x] **K5: Track simplification** (4-5 hours)
  ...
  - Tests: `tests/integration/GpxSimplification.test.tsx`
...
- [x] **K6: Heatmap visualization** (8-10 hours)
  ...
  - Tests: `tests/unit/components/preview/HeatmapOverlay.test.tsx`, `tests/integration/Heatmap.test.tsx`

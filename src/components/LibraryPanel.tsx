  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex justify-between items-center p-4 border-b border-neutral-700 bg-neutral-800">
        ...
        <Tooltip content="Add video, audio, or GPX files" position="bottom">
        ...
        <ul className="space-y-1">
          {assets.map(asset => (
            <li
              ...
              className={`p-2 cursor-pointer rounded flex gap-3 items-start transition-colors ${
                asset.id === selectedAssetId ? 'bg-neutral-700' : 'hover:bg-neutral-800/50'
                  ...
                  asset.type === 'video' ? 'border-blue-500' :
                  asset.type === 'audio' ? 'border-emerald-500' :
                  'border-orange-500'
              }`}
              role="button"
            ...
            >
              ...
              {asset.type === 'audio' && (
                  <div className="w-16 h-10 bg-neutral-900 rounded overflow-hidden flex-shrink-0 flex items-center justify-center text-emerald-500">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-neutral-400 mt-0.5">
                  <span className={`inline-block w-2 h-2 rounded-full mr-1 ${
                      ...
                      asset.type === 'audio' ? 'bg-emerald-500' :
                      'bg-orange-500'
                  }`}></span>
